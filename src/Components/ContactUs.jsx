                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="contact-content">
                                ...
                                <form id="contactform" method="post" action="https://themesflat.co/html/homzen/contact/contact-process.php" className="form-contact">
                                    ...
                                    <fieldset className="box">
                                        ...
                                        <textarea name="message" className="form-control" cols="30" rows="10" placeholder="Message"  id="message" required></textarea>
                                    </fieldset>
